                ...
                data.strapiAboutUs.Gallery.map((item, i) => {
                  return(
                    <SwiperSlide className={`block-gallery db`} >
                      <div className={`container-block-gallery`} onClick={this.addPopupClass.bind(this, i)}>
          ...
          </div>
          {
            ...
            data.strapiAboutUs.Gallery.map((item, i) => {
              return(
                ...
                <div className={`container-popup-image ${this.state.i === i && this.state.show ? "open-popup-gallery" : " "}`}>
                  <img src={item.Photo.childImageSharp.fixed.src}  alt={''} />
                </div>
                </>
